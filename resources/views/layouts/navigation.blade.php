                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-custom.nav-dropdown-wrapper :active="(request()->routeIs('expense-categories.index') || request()->routeIs('income-categories.index'))">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('expense-categories.index')" :active="request()->routeIs('expense-categories.index')">
                                    {{ __('Expense') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('income-categories.index')" :active="request()->routeIs('income-categories.index')">
                                    {{ __('Income') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="px-4">
                    <div class="font-medium text-base text-gray-800">{{ __('Categories') }}</div>
                </div>
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('income-categories.index')" :active="request()->routeIs('income-categories.index')">
